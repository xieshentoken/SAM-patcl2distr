...
parser.add_argument('--img_file', type=str, 
                    default='/Users/hsh/OpenCV practise/SAM seg demo/imgs/test2.jpg', help='image file')
parser.add_argument('--metric_cofig_file', type=str, 
                    default='/Users/hsh/OpenCV practise/SAM seg demo/config/metric_cofig.txt', help='metric config file')
